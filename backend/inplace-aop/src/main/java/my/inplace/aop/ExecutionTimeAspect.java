package my.inplace.aop;

import lombok.RequiredArgsConstructor;
import my.inplace.common.aop.ThreadExecutionContext;
...
public class ExecutionTimeAspect {
    ...
    @Around("@within(my.inplace.application.annotation.Facade)")
    ...
    @Around("@within(my.inplace.infra.annotation.Client)")
