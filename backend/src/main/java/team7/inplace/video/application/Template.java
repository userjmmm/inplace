...
public enum Template {
    ...
    RESTAURANT(new String[]{
        "이(가) 추천하는 맛집! 다양한 메뉴를 즐길 수 있습니다.",
        "이(가) 방문한 식당에서 맛있는 음식을 즐겨보세요!",
        "이(가) 추천하는 맛집에서 특별한 시간을 보내보세요!"
    }),

    NONE(new String[]{
        "이(가) 방문한 곳에서 특별한 추억을 만들어보세요!",
        "이(가) 추천하는 장소에서 특별한 경험을 해보세요!",
        "이(가) 방문한 곳에서 특별한 시간을 보내보세요!"
    });
