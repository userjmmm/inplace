...
import my.inplace.application.crawling.dto.CrawlingInfo.VideoPlaceInfo;
...
public class YoutubeCrawlingCommandService {
     ...
     */
    public List<VideoPlaceInfo> crawlAllVideos() {
